...
```{r ans24}
nightOwlVoteShare<-length(nightOwl)
nightOwlVoteShare
```
...
```{r ans32}
b<-as.integer(studentID=="046S6f645" & schoolYear==100)
credit100ChosenStudent<-sum(b*credit)
...
```{r ans33}
d<-(as.integer(studentID=="046S6f645" & schoolYear==100 &grade>=60))
earnedCredit100ChosenStudent<-sum(d*credit)
